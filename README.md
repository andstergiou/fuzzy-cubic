...
| $\hat{H}_{\mathrm{trans}}$ | Single-particle energy splitting between singlet and triplet flavours, corresponding to the kinetic term of the rotor model; `h` is tuned to reach the critical point |
